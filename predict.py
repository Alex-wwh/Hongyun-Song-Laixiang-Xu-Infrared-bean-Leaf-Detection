...
# 指定包含图片的文件夹路径
folder_path = r"C:\Users\shys\Desktop\zm\SCI论文\SCI投稿\豆角\pre"
...
for i in range(100):
    ...
    with open(r"C:\Users\shys\Desktop\python作业.txt", 'a', encoding='utf-8') as file:
        file.write(data)
